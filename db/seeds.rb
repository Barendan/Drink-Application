...
Product.create!(name: "Johnnie Walker Black", price: 51.99, size: "1.75l",type_id: 2, brand_id: 32)
Product.create!(name: "Dewar's White Label", price: 28.99, size: "1.75l",type_id: 2, brand_id: 33)
Product.create!(name: "Macallan 12 Yr", price: 50.99, size: "750ml",type_id: 2, brand_id: 34)
Product.create!(name: "Johnnie Walker Red", price: 28.99, size: "1.75l",type_id: 2, brand_id: 32)
Product.create!(name: "Glenlivet 12 Yr", price: 66.99, size: "1.75l",type_id: 2, brand_id: 35)
Product.create!(name: "Johnnie Walker Blue", price: 185.99, size: "750ml",type_id: 2, brand_id: 32)
Product.create!(name: "Glenlivet 12 Yr", price: 31.99, size: "750ml",type_id: 2, brand_id: 35)
Product.create!(name: "Chivas Regal", price: 46.99, size: "1.75l",type_id: 2, brand_id: 36)
Product.create!(name: "Balvenie 12 Yr Double Wood", price: 51.99, size: "750ml",type_id: 2, brand_id: 37)
Product.create!(name: "Shieldaig Speyside Single Malt 18Yr", price: 44.99, size: "750ml",type_id: 2, brand_id: 46)
Product.create!(name: "Johnnie Walker Black", price: 29.49, size: "750ml",type_id: 2, brand_id: 32)
Product.create!(name: "Famous Grouse", price: 24.99, size: "1.75l",type_id: 2, brand_id: 39)
Product.create!(name: "Lagavulin 16 Yr", price: 99.99, size: "750ml",type_id: 2, brand_id: 40)
Product.create!(name: "Clan MacGregor", price: 15.99, size: "1.75l",type_id: 2, brand_id: 41)

Product.create!(name: "Maker's Mark", price: 46.99, size: "1.75l",type_id: 4, brand_id: 64)
Product.create!(name: "Jim Beam", price: 22.99, size: "1.75l",type_id: 4, brand_id: 65)
Product.create!(name: "Evan Williams", price: 17.99, size: "1.75l",type_id: 4, brand_id: 66)
Product.create!(name: "Angel's Envy", price: 46.99, size: "750ml",type_id: 4, brand_id: 67)
Product.create!(name: "Maker's Mark", price: 22.99, size: "750ml",type_id: 4, brand_id: 64)
Product.create!(name: "Bulleit Bourbon", price: 24.99, size: "750ml",type_id: 4, brand_id: 68)
Product.create!(name: "Woodford Reserve", price: 26.99, size: "750ml",type_id: 4, brand_id: 69)
Product.create!(name: "Basil Hayden 8 Yr", price: 45.99, size: "750ml",type_id: 4, brand_id: 70)
Product.create!(name: "Woodford Reserve", price: 64.99, size: "1.75l",type_id: 4, brand_id: 69)
Product.create!(name: "Southern Comfort", price: 18.99, size: "1.75l",type_id: 4, brand_id: 71)
Product.create!(name: "Early Times", price: 15.99, size: "1.75l",type_id: 4, brand_id: 72)
Product.create!(name: "Maker's 46", price: 33.99, size: "750ml",type_id: 4, brand_id: 73)
Product.create!(name: "Knob Creek 100", price: 64.99, size: "1.75l",type_id: 4, brand_id: 74)
Product.create!(name: "Two Stars Bourbon", price: 42.99, size: "1.75l",type_id: 4, brand_id: 75)
Product.create!(name: "Wild Turkey 101", price: 34.99, size: "1.75l",type_id: 4, brand_id: 76)
Product.create!(name: "Buffalo Trace Bourbon", price: 22.99, size: "750ml",type_id: 4, brand_id: 77)
Product.create!(name: "Four Roses Single Barrel", price: 39.99, size: "750ml",type_id: 4, brand_id: 78)
Product.create!(name: "1792 Bourbon", price: 28.99, size: "750ml",type_id: 4, brand_id: 79)

Product.create!(name: "Captain Morgan's Spiced Rum", price: 18.99, size: "1.75l",type_id: 5, brand_id: 107)
Product.create!(name: "Bacardi Superior", price: 18.99, size: "1.75l",type_id: 5, brand_id: 108)
Product.create!(name: "Malibu Coconut Rum", price: 19.99, size: "1.75l",type_id: 5, brand_id: 109)
Product.create!(name: "Bacardi Gold", price: 18.99, size: "1.75l",type_id: 5, brand_id: 108)
Product.create!(name: "Ron Zacapa 23Yr Centenario Rum", price: 35.99, size: "750ml",type_id: 5, brand_id: 110)
Product.create!(name: "Sailor Jerry Spiced Rum", price: 20.99, size: "1.75l",type_id: 5, brand_id: 111)
Product.create!(name: "Mount Gay Eclipse", price: 31.99, size: "1.75l",type_id: 5, brand_id: 112)
Product.create!(name: "Bacardi Limon", price: 19.99, size: "1.75l",type_id: 5, brand_id: 108)
Product.create!(name: "Malibu Coconut Rum", price: 12.29, size: "750ml",type_id: 5, brand_id: 109)
Product.create!(name: "Kaniche XO Artisanal Rum", price: 29.99, size: "1.75l",type_id: 5, brand_id: 113)
Product.create!(name: "Bacardi Superior", price: 10.49, size: "750ml",type_id: 5, brand_id: 108)
Product.create!(name: "Bacardi Superior", price: 15.99, size: "1l",type_id: 5, brand_id: 108)
Product.create!(name: "Largo Bay Silver Rum", price: 17.99, size: "1.75l",type_id: 5, brand_id: 114)
Product.create!(name: "Captain Morgan's Spiced Rum", price: 11.99, size: "750ml",type_id: 5, brand_id: 107)
Product.create!(name: "Myers's Dark", price: 41.99, size: "1.75l",type_id: 5, brand_id: 115)
Product.create!(name: "Kraken Black Spiced Rum", price: 27.99, size: "1.75l",type_id: 5, brand_id: 116)
Product.create!(name: "Bacardi Black", price: 19.99, size: "1.75l",type_id: 5, brand_id: 108)
Product.create!(name: "Cruzan Rum Dark", price: 15.99, size: "1.75l",type_id: 5, brand_id: 117)
Product.create!(name: "Zaya 12 Yr Rum", price: 29.99, size: "750ml",type_id: 5, brand_id: 119)
Product.create!(name: "Gosling's Black Seal Rum", price: 34.49, size: "1.75l",type_id: 5, brand_id: 120)
Product.create!(name: "Ronrico Silver", price: 13.49, size: "1.75l",type_id: 5, brand_id: 121)


Product.create!(name: "Tanqueray Gin", price: 29.99, size: "1.75l",type_id: 6, brand_id: 140)
Product.create!(name: "Bombay Sapphire", price: 31.99, size: "1.75l",type_id: 6, brand_id: 141)
Product.create!(name: "Beefeater", price: 23.99, size: "1.75l",type_id: 6, brand_id: 142)
Product.create!(name: "Gordon's Gin", price: 12.99, size: "1.75l",type_id: 6, brand_id: 143)
Product.create!(name: "Hendricks Gin", price: 54.99, size: "1.75l",type_id: 6, brand_id: 144)
Product.create!(name: "Hendricks Gin", price: 29.99, size: "750ml",type_id: 6, brand_id: 144)
Product.create!(name: "Bombay", price: 23.99, size: "1.75l",type_id: 6, brand_id: 141)
Product.create!(name: "Seagram's Gin", price: 17.99, size: "1.75l",type_id: 6, brand_id: 145)
Product.create!(name: "Tanqueray", price: 18.99, size: "750ml",type_id: 6, brand_id: 140)
Product.create!(name: "G&J Greenall's Gin", price: 22.99, size: "1.75l",type_id: 6, brand_id: 146)
Product.create!(name: "New Amsterdam Straight Gin", price: 19.99, size: "1.75l",type_id: 6, brand_id: 147)
Product.create!(name: "Bombay Sapphire", price: 20.99, size: "750ml",type_id: 6, brand_id: 141)
Product.create!(name: "Gilbey's Gin", price: 12.99, size: "1.75l",type_id: 6, brand_id: 148)
Product.create!(name: "Tanqueray Rangpur", price: 40.99, size: "1.75l",type_id: 6, brand_id: 140)
Product.create!(name: "Burnett's Gin", price: 13.49, size: "1.75l",type_id: 6, brand_id: 149)
Product.create!(name: "Tanqueray No. Ten Gin", price: 32.49, size: "750ml",type_id: 6, brand_id: 140)


Product.create!(name: "Hennessy VS", price: 27.99, size: "750ml",type_id: 7, brand_id: 187)
Product.create!(name: "Hennessy VS", price: 73.99, size: "1.75l",type_id: 7, brand_id: 187)
Product.create!(name: "Remy Martin VSOP", price: 31.99, size: "750ml",type_id: 7, brand_id: 188)
Product.create!(name: "Hennessy VS", price: 53.99, size: "1l",type_id: 7, brand_id: 187)
Product.create!(name: "Remy Martin 1738", price: 47.99, size: "750ml",type_id: 7, brand_id: 188)
Product.create!(name: "E & J Brandy", price: 23.49, size: "1.75l",type_id: 7, brand_id: 189)
Product.create!(name: "Christian Bros Brandy", price: 21.49, size: "1.75l",type_id: 7, brand_id: 192)
Product.create!(name: "Courvoisier VS", price: 22.99, size: "750ml",type_id: 7, brand_id: 193)
Product.create!(name: "Remy Martin XO", price: 139.99, size: "750ml",type_id: 7, brand_id: 188)
Product.create!(name: "Martell Cordon Bleu", price: 149.99, size: "750ml",type_id: 7, brand_id: 194)
Product.create!(name: "E & J Brandy VSOP", price: 25.49, size: "1.75l",type_id: 7, brand_id: 189)
